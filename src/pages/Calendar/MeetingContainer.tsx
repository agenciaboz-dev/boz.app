...
export const MeetingContainer: React.FC<MeetingContainerProps> = ({ meeting }) => {
    ...
    const startTime = new Date(meeting.start.dateTime as string).toLocaleTimeString("pt-br", { hour: "2-digit", minute: "2-digit" })

    return (
        <Box sx={{ alignItems: "center", gap: "0.3vw", padding: "0.3vw 0" }}>
            <Box
                sx={{
                    width: size,
                    height: size,
